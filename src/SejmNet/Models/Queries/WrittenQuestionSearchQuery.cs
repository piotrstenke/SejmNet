...
{
	/// <summary>
	/// Represents a query for searching written questions.
	/// </summary>
	public sealed class WrittenQuestionSearchQuery
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="WrittenQuestionSearchQuery"/> class.
		/// </summary>
		public WrittenQuestionSearchQuery()
		{
		}
	}
}
